...
<body class="bg-gray-100">
    ...
    <img src="logo.png" alt="" class="w-20 h-20 object-contain">
        ...
        <main class="relative z-10 flex items-center justify-center min-h-[85vh] px-6">
            <div class="max-w-4xl text-center text-white">
                ...
                <h2 class="text-4xl md:text-6xl font-bold leading-tight mb-6">
                    Dari Siswa,<br>
                     Oleh Siswa,<span class="text-blue-400">Untuk Perbaikan Bersama</span>
                </h2>

                <p class="text-lg md:text-xl text-slate-200 max-w-2xl mx-auto mb-8 leading-relaxed">
                    Sampaikan keluhan, kritik, atau saran Anda secara aman dan mudah. 
                    Kami berkomitmen untuk mendengarkan setiap aspirasi demi menciptakan lingkungan belajar yang nyaman, 
